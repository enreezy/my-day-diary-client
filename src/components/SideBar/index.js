        ...
        return (
            ...
            >
                <SubMenu key="sub1" icon={<UserOutlined />} title="Diaries">
                    <Menu.Item key="1"><Link to="/diaries">Diaries</Link></Menu.Item>
                    <Menu.Item key="2"><Link to="/create">Create New</Link></Menu.Item>
                </SubMenu>
                <SubMenu key="sub2" icon={<LaptopOutlined />} title="About">
